...
class _PlayerModuleState extends State<PlayerModule> {
  ...
  Widget build(BuildContext context) {
    ...
    final cvalue = assetControl.value.toInt();
    final casset = assets.range.contains(cvalue) ? assets[cvalue] : null;
    final cname = casset?.name;
                          ...
                          slivers: [
                            SliverGrid.builder(
                              ...
                              itemBuilder: (_, i) => UIContextMenu(
                                menu: [
                                  if (Platform.isMacOS && assets[i].uri != null)
                                    UIMenuItem(
                                      text: 'Show in finder',
                                      icon: UIIcon.finder,
                                      onTap: () {
                                        OpenFileMacos().open(
                                          assets[i].uri!.replaceAll(
                                            'file:',
                                            '',
                                          ),
                                          viewInFinder: true,
                                ...
                                child: AssetView(
                                  ...
                                  moduleId: module.id,
                                  asset: assets[i],
                                  selected: assetControl.value.toInt() == i,
                                  control: assetControl.value.toInt() == i
                                      ? positionControl
                                      : null,
                                  onTap: () {
                                    if (assetControl.value.toInt() != i) {
