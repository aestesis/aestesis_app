...
// TODO: use okcolor https://pub.dev/packages/okcolor
/////////////////////////////////////////////////////////////////////////////////////////////////
/////////////////////////////////////////////////////////////////////////////////////////////////
                        ...
                        SliverGrid.builder(
                          ...
                          gridDelegate:
                              SliverGridDelegateWithMinMaxCrossAxisExtent(
                                ...
                                crossAxisSpacing: 10,
                                mainAxisSpacing: 10,
                                mainAxisExtent: 100 + 160 / (aes.compositionSettings?.aspectRatio ?? 16/9),
                              ),
...
class _AnalogInputState extends State<AnalogInput> {
  ...
  Widget build(BuildContext context) {
    ...
    return Center(
      child: Container(
        width: 160,
        //height: 100 + 160 / (aes.compositionSettings?.aspectRatio ?? 16/9),
              ...
              child: Stack(
                children: [
                  ...
                  Positioned.fill(
                    top: 14,
                    child: Center(
                      child: ControlKnob(control: opacity, size: UISize.large),
                    ),
                  ),
                  Positioned(
                    right: 17.5,
                    bottom: 8,
                    child: ControlColor(control: color, size: UISize.medium),
                  ),
                  Positioned(
                    right: 11,
                    top: 16,
