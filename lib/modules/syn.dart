...
/////////////////////////////////////////////////////////////////////////////////////////////////
/////////////////////////////////////////////////////////////////////////////////////////////////
class SynModule extends StatefulWidget {
  final String moduleId;
  const SynModule({super.key, required this.moduleId});
  @override
  State<SynModule> createState() => _SynModuleState();
}

/////////////////////////////////////////////////////////////////////////////////////////////////
class _SynModuleState extends State<SynModule> {
  final scrollController = ScrollController();
  late final StreamSubscription assetChangedSubscription;
  @override
  void initState() {
    super.initState();
    assetChangedSubscription = module[SynControl.asset.id].listen((_) {
      if (mounted) setState(() {});
    });
  }
